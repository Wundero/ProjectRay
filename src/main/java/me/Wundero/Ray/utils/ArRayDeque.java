...
public class ArRayDeque<E> extends AbstractCollection<E> implements Deque<E>, Cloneable, Serializable {
	...
	/**
	 * The strictness of object equality checks.
	 */
	transient Tristate strict = Tristate.FALSE;

	/**
	 * Whether to immutize the iter blocks.
	 */
	 ...
	 * hold 16 elements. Strictness is weak with equals checks.
	 */
	public ArRayDeque() {
	...
	/**
	 * Constructs an empty array deque with an initial capacity sufficient to
	 * hold 16 elements and checks strictness based off of the tristate.
	 */
	public ArRayDeque(Tristate strict, boolean sync) {
		this();
		this.strict = strict;
		this.sync = sync;
	}
	...
	private boolean equals(Object internal, Object external) {
		if (strict == Tristate.TRUE) {
			return internal.equals(external) && external.equals(internal);
	...
	public Iterator<E> iterator() {
		return sync ? new ImmutableDeque<E>(this).iterator() : new DeqIterator();
	}

	public Iterator<E> descendingIterator() {
		return sync ? new ImmutableDeque<E>(this).descendingIterator() : new DescendingIterator();
	}
	...
	public Spliterator<E> spliterator() {
		return sync ? new ImmutableDeque<E>(this).spliterator() : new DeqSpliterator<E>(this, -1, -1);
	}
